...
public:
    ...
    // === 管理医疗记录 ===
    void manageRegistrations(Registration *&reg, const std::string &department);            // 管理挂号记录（查看、修改状态等）
    ...
    void manageConsultations(Consultation *&con, const std::string &department);            // 管理看诊记录（查看、修改诊断结果等）
    void manageExaminations(Examination *&exam, const std::string &department);             // 管理检查记录（查看、修改报告摘要等）
    void manageHospitalizations(Hospitalization *&hos, const std::string &department);      // 管理住院记录（查看、修改出院日期等）
    void manageMedicationRecords(MedicationRecord *&medRec, const std::string &department); // 管理用药记录（查看、修改用药详情等）
    void manageMedicines(Medicine *&med, const std::string &department);                    // 管理药品信息（查看、修改库存等）
};
