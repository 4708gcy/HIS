...
{
public:
    static std::vector<std::pair<std::string, std::string>> loadInteractions(const std::string &filePath);
    static bool hasInteraction(const std::string &drug1, const std::string &drug2,
                               const std::vector<std::pair<std::string, std::string>> &interactions);
    static std::vector<std::string> checkAllergyConflict(
